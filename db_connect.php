...
// กำหนดค่าคงที่สำหรับไดเร็กทอรี่
...
try {
    ...
    // ตรวจสอบและสร้างตารางที่จำเป็นหากยังไม่มี
...
/**
 * ฟังก์ชันสำหรับสร้างตารางที่จำเป็นในฐานข้อมูล
 */
...
/**
 * ฟังก์ชันสร้างคีย์เข้ารหัสแบบสุ่ม
 */
function getEncryptionKey() {
    return random_bytes(32); // คีย์ขนาด 256 บิต
}
?>