            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input type="text" name="tournament_name" id="tournament_name" required placeholder="ใส่ชื่อทัวร์นาเมนต์..." value="<?php echo isset($_POST['tournament_name']) ? htmlspecialchars($_POST['tournament_name']) : ''; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input type="text" name="tournament_url" id="tournament_url" required placeholder="ROV_RMUTI5" value="<?php echo isset($_POST['tournament_url']) ? htmlspecialchars($_POST['tournament_url']) : ''; ?>">
                    </div>
                    <div class="form-help">
                        <i class="fas fa-info-circle"></i>
